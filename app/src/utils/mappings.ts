...
export const arrayOfObjectsToDictionary = <T extends { [key in string | number | symbol]: T[keyof T] }>(
  arrayToMap: T[],
  ...
  arrayToMap.reduce((hash, obj) => {
    ...
    if (typeof objectKey === 'string' || typeof objectKey === 'number' || typeof objectKey === 'symbol') {
